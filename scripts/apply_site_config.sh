...
set_text_optional input_text.se_nf_backup_reserve_entity "${BACKUP_RESERVE_ENTITY:-}"
...
set_number input_number.se_nf_backup_reserve_fallback_pct "${BACKUP_RESERVE_FALLBACK_PCT:-0}"
